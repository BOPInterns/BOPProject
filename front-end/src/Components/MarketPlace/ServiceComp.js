...
export const ServiceComp = () => {
  ...
  const loadServiceCards = () => {
    ...
    for (let i = 0; i < fulls; i++) {
      rows.push(
        <Row>
          <Col>
            <ServiceCard servData={loadServiceData(num)} />
          </Col>
          <Col>
            <ServiceCard servData={loadServiceData(num + 1)} />
          </Col>
          <Col>
            <ServiceCard servData={loadServiceData(num + 2)} />
          </Col>
          <Col>
            <ServiceCard servData={loadServiceData(num + 3)} />
          </Col>
        </Row>
      );
      num += 4;
  ...
  return (
    <div>
      ...
      <Row className="mt-3">{loadServiceCards()}</Row>
      <Row className="mt-3 text-center">
        <Col text-center>
          <Button variant="secondary">Load more services</Button>
        </Col>
      </Row>
    </div>
  );
